...
export const BalloonGameScreen: React.FC<ScreenProps> = ({ onNavigate }) => {
  const [level, setLevel] = useState<1 | 2 | 3>(1);
  const [gameStatus, setGameStatus] = useState<"start" | "playing" | "success" | "failure">("start");
  ...
  // Logic to save result (same as before)
